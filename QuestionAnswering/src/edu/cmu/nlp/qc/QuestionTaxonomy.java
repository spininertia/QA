...
public class QuestionTaxonomy {
	...
	public static HashMap<Integer, String> generalIdxCat = new HashMap<Integer, String>();
	...
	public static HashMap<Integer, String> deepIdxCat = new HashMap<Integer, String>();
	...
	static {
		try {
			...
			while(sc.hasNextLine()){
				...
				generalIdxCat.put(idx, tokens[0]);
			...
			while(sc.hasNextLine()){
				...
				deepIdxCat.put(idx, general + ":" + tokens[0]);
	...
	public static void main(String[] args){
		System.out.println(QuestionTaxonomy.deepDesc.size());
		System.out.println(QuestionTaxonomy.generalDesc.size());
		System.out.println(QuestionTaxonomy.generalCatIdx);
		System.out.println(QuestionTaxonomy.deepCatIdx);
	}
}
