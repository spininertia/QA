...
public class HeadFinderWh extends CollinsHeadFinder {
	public HeadFinderWh() {
		this(new PennTreebankLanguagePack());
	}

	public HeadFinderWh(TreebankLanguagePack tlp) {
		super(tlp);

		// just throw away the nonTerminalInfo created by the superclass
		// ModCollins extends Collins just so it can use the same
		// postOperationFix.
		...
		nonTerminalInfo.put("ADJP", new String[][] { { "left", "NNS", "NN",
				"$", "QP", "JJ", "VBN", "VBG", "ADJP", "JJR", "NP", "JJS",
		...
		nonTerminalInfo.put("PP", new String[][] {
				{ "right", "IN", "TO", "VBG", "VBN", "RP", "FW" },
				{ "right", "PP" } });

		// should prefer JJ? (PP (JJ such) (IN as) (NP (NN crocidolite)))

		nonTerminalInfo.put("PRN", new String[][] { { "left", "VP", "NP", "PP",
				"S", "SINV", "SBAR", "ADJP", "ADVP", "INTJ", "WHNP", "NAC",
				"VBP", "JJ", "NN", "NNP" } });
		nonTerminalInfo.put("PRT", new String[][] { { "right", "RP" } });
		// add '#' for pounds!!
		nonTerminalInfo.put("QP",
				new String[][] { { "left", "$", "IN", "NNS", "NN", "JJ", "CD",
						"PDT", "DT", "RB", "NCD", "QP", "JJR", "JJS" } });
		nonTerminalInfo.put("RRC", new String[][] { { "right", "VP", "NP",
				"ADVP", "ADJP", "PP" } });

		// delete IN -- go for main part of sentence; add FRAG

		nonTerminalInfo.put("S", new String[][] { { "left", "TO", "VP", "S",
				"FRAG", "SBAR", "ADJP", "UCP", "NP" } });
		nonTerminalInfo.put("SBAR", new String[][] { { "left", "WHNP", "WHPP",
				"WHADVP", "WHADJP", "IN", "DT", "S", "SQ", "SINV", "SBAR",
				"FRAG" } });
		nonTerminalInfo.put("SBARQ", new String[][] { { "left", "WHNP", "WHPP",
			"WHADVP", "WHADJP", "SQ", "S",
				"SINV", "SBARQ", "FRAG" } });
		...
		nonTerminalInfo.put("WHPP", new String[][] { { "right", "IN", "TO",
				"FW" } });
		nonTerminalInfo.put("X", new String[][] { { "right", "S", "VP", "ADJP",
				"NP", "SBAR", "PP", "X" } });
		nonTerminalInfo.put("NP", new String[][] {
				...
				{ "rightdis", "$", "ADJP", "PRN" },
				{ "right", "CD" },
				{ "rightdis", "JJ", "JJS", "RB", "QP", "DT", "WDT", "RBR",
						"ADVP" } });
		nonTerminalInfo.put("POSSP", new String[][] { { "right", "POS" } });

		/*
		 * HJT: Adding the following to deal with oddly formed data in (for
		 * example) the Brown corpus
		 */
		nonTerminalInfo.put("ROOT", new String[][] { { "left", "S", "SQ",
				"SINV", "SBAR", "FRAG" } });
		nonTerminalInfo.put("TYPO", new String[][] { { "left", "NN", "NP",
				"NNP", "NNPS", "TO", "VBD", "VBN", "MD", "VBZ", "VB", "VBG",
				"VBP", "VP", "ADJP", "FRAG" } }); // for Brown (Roger)
		nonTerminalInfo.put("ADV", new String[][] { { "right", "RB", "RBR",
				"RBS", "FW", "ADVP", "TO", "CD", "JJR", "JJ", "IN", "NP",
				"JJS", "NN" } });
	...
	private static final long serialVersionUID = -5870387455902637256L;
}
